...
class ITE_model:
    ...
    def __load_models(self):
        ...
        self.__off_mod = TFAutoModel.from_pretrained(off_MOD)
        ...
        self.__ITE_mod = tf.keras.models.load_model('ITE_model/models/ITE_model')
        self.__PEACE = tf.keras.models.load_model('ITE_model/models/PEACE_model')
    ...
    def __Compute_PEACE_inputs(self,texts,batch_size):
        ...
        for batch in batches:
            ...
            emb_2 = self.__off_mod(encoded_inputs)[0]
            pool_2 = GlobalAveragePooling1D()(emb_2).numpy()
            batch_out_2.append(pool_2)
        
            emb_3 = self.__gen_mod(encoded_inputs)[0]
    ...
    def Hate(self,texts):
        sent_emb,off_emb,gen_emb = self.__Compute_PEACE_inputs(texts,self.__batch_size)
        conc_emb = np.concatenate([sent_emb,off_emb,gen_emb],axis=1)
